...
const CircularText = ({
  ...
  return (
    <motion.div
      initial={{ rotate: 0 }}
      className={`mx-auto rounded-full w-[150px] h-[150px] flex items-center cursor-grab justify-center text-white font-black text-center origin-center ${className}`}
      animate={controls}
      ...
      {letters.map((letter, i) => {
        ...
        return (
          <span
            ...
            style={{ transform, WebkitTransform: transform, fontFamily: 'Akira' }}
          >
            {letter}
          </span>
        );
      })}
      <span><CodeXml size={50} strokeWidth={2} strokeLinecap="butt"/></span>
    </motion.div>
  );
};
